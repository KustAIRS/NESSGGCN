...
class Felzenszwalb(object):
    def __init__(self, HSI, labels, scale=100, sigma=0.5, min_size=50):
        self.scale = scale
        self.sigma = sigma
    ...
    def get_Q_and_S_and_Segments(self):
        ...
        # ax.imshow(out)
        # fig.savefig('/media/rslab/Workplace/Huanglh/论文_New/HC/Fel', dpi=300)
...
class LDA_SLIC(object):
    ...
    def SLIC_Process(self, img):
        myslic = Felzenszwalb(img, self.labels, scale=1000, sigma=0.5, min_size=50)
